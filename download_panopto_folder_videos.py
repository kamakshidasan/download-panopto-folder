...
cookies = {
    'unified\engs2350@ox.ac.uk': parameters,
    '.ASPXAUTH': '<FILL THIS>',
    '<something>\engs2350@ox.ac.uk': 'true',
...
parameters = {
    "defaultVolume":100,
    "defaultEmbedVolume":100,
    "sortData-lastSessionSort":"{\"column\":8,\"currentAscending\":true}",
    "lastSessionView":1
}

headers = {
    'authority': 'ox.cloud.panopto.eu',
    'pragma': 'no-cache',
    ...
    'accept': '*/*',
    'origin': 'https://ox.cloud.panopto.eu',
    'sec-fetch-site': 'same-origin',
    'sec-fetch-mode': 'cors',
    'sec-fetch-dest': 'empty',
    'referer': 'https://ox.cloud.panopto.eu/Panopto/Pages/Sessions/List.aspx',
...
response = requests.post('https://ox.cloud.panopto.eu/Panopto/Services/Data.svc/GetSessions',
...
for id in tqdm(ids):
    headers = {
        ...
        'referer': f"https://ox.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id={id}",
        'accept-language': 'en-US,en;q=0.9,el;q=0.8,ko;q=0.7,fr;q=0.6',
    }
    ...
    with requests.get(f"https://ox.cloud.panopto.eu/Panopto/Podcast/Download/{id}.mp4", headers=headers, params=params, cookies=cookies, stream=True) as r:
        r.raise_for_status()
